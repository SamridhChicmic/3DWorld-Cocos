  ...
  keyBoardDown(event: EventKeyboard) {
    ...
    switch (event.keyCode) {
      ...
      case KeyCode.ARROW_LEFT:
        ...
        //  })
        // .start();
        AngleLeft = this.node.eulerAngles;
        ...
        if (AngleLeft.y == 270) {
          this.index = 6;
          this.node.eulerAngles = new Vec3(AngleLeft.x, -90, AngleLeft.z);
          console.log("Axis", this.AxisArray[this.index]);
        }
      ...
      case KeyCode.ARROW_RIGHT:
        ...
        (this.node.eulerAngles = new Vec3(
          ...
          //  }).start();
          (AngleRight = this.node.eulerAngles);
        AngleRight = new Vec3(AngleRight.x, AngleRight.y % 360, AngleRight.z);
        if (AngleRight.y == 180) {
          this.index = 0;
          console.log("Axis", this.AxisArray[this.index]);
        ...
        if (AngleRight.y == -90) {
          this.index = 6;
          this.node.eulerAngles = new Vec3(AngleRight.x, 270, AngleRight.z);
          console.log("Axis", this.AxisArray[this.index]);
        }
